...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='css/frmLogin.css?v=1.2'>
    <title>Login</title>
</head>
<body>
<header>
    ...
    <?php 
        ...
        include "controlador/clsLogin.php";
    ?>   
    <br/>
    <section class="contenedor">
        <form action="" method="POST" name="entrar">
            ...
            <table>
                ...
                <tr>
                    <th colspan="7" class="th2"><a href="frmRegistro.php">Registrar</a></th>
                </tr>
                <tr>
                    <th colspan="7" class="th2"><a href="frmRecuperacion.php">Olvidé mi contraseña</a></th>
                </tr>
            </table>
        </form>    
    </section>
